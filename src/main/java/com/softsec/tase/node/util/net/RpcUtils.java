package com.softsec.tase.node.util.net;
...
public class RpcUtils {
	...
	public static NodeTrackerService.Client getReceiver(String ip, int port, int timeout, int retryTimes) throws TTransportException {
		TProtocol protocol = prepare(ip, port, timeout, retryTimes);
		return new NodeTrackerService.Client(protocol);
	}
